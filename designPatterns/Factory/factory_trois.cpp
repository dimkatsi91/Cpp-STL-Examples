...
////////////////////////////////////////////////////////////////////////////////////
public:
    static DebianFactory DebFactory;
...
int main() {
    ...
    cout << "*******************************************************\n";
    auto cinOS = Debian::DebFactory.Cinammon(1, 10);
    cout << cinOS;

    cout << "*******************************************************\n";
    // diman KDE on Debian
    auto kdeOS = Debian::DebFactory.Kde(1, 10);
    cout << kdeOS;

    cout << "*******************************************************\n";
    // diman Gnome on Debian
    auto gnomeOS = Debian::DebFactory.Gnome(1, 10);
    cout << gnomeOS;
